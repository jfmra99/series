...
files_names= list.files(pattern="*.csv", path =  paste(getwd(),"/Data",sep=""))
path <- paste(getwd(),"/Data/",files_names[-6],sep="")
...
df_2019 <- read.csv(paste(getwd(),"/Data/",files_names[6],sep=""), header=T,
                 encoding="UTF-8")
```
